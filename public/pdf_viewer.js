  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __w_pdfjs_require__) {
        ...
        _pdfjsLib.PDFJS.disableFullscreen =
          _pdfjsLib.PDFJS.disableFullscreen === undefined
            ? false
            : _pdfjsLib.PDFJS.disableFullscreen
        _pdfjsLib.PDFJS.useOnlyCssZoom =
          _pdfjsLib.PDFJS.useOnlyCssZoom === undefined
            ? false
            : _pdfjsLib.PDFJS.useOnlyCssZoom
        _pdfjsLib.PDFJS.maxCanvasPixels =
          _pdfjsLib.PDFJS.maxCanvasPixels === undefined
            ? 16777216
            : _pdfjsLib.PDFJS.maxCanvasPixels
        _pdfjsLib.PDFJS.disableHistory =
          _pdfjsLib.PDFJS.disableHistory === undefined
            ? false
            : _pdfjsLib.PDFJS.disableHistory
        _pdfjsLib.PDFJS.disableTextLayer =
          _pdfjsLib.PDFJS.disableTextLayer === undefined
            ? false
            : _pdfjsLib.PDFJS.disableTextLayer
        {
          _pdfjsLib.PDFJS.locale =
            _pdfjsLib.PDFJS.locale === undefined &&
                        ...
                        .catch(function() {
                          console.error(
                            'PDFLinkService.navigateTo: "' +
                              destRef +
                              '" is not ' +
                              ('a valid page reference, for dest="' +
                                dest +
                                '".')
                          )
                        })
              ...
              value: function paintOnCanvas(canvasWrapper) {
                ...
                if (_pdfjsLib.PDFJS.maxCanvasPixels > 0) {
                  ...
                  var maxScale = Math.sqrt(
                    _pdfjsLib.PDFJS.maxCanvasPixels / pixelsInViewport
                  )
          ...
          _createClass(BaseViewer, [
                      ...
                      var _loop = function _loop(_pageNum) {
                        pdfDocument.getPage(_pageNum).then(
                          function(pdfPage) {
                            ...
                            _this.linkService.cachePageRef(
                              _pageNum,
                              pdfPage.ref
                            )
                            if (--getPagesLeft === 0) {
            ...
            },
            {
              ...
              value: function getPagesOverview() {
                ...
                var isFirstPagePortrait = isPortraitOrientation(
                  pagesOverview[0]
                )
            ...
            },
            {
              ...
              value: function downloadData(data, filename, contentType) {
                ...
                var blobUrl = (0, _pdfjsLib.createObjectURL)(
                  data,
                  contentType,
                  _pdfjsLib.PDFJS.disableCreateObjectURL
                )
        ...
        var PDFFindController = (function() {
          ...
          _createClass(PDFFindController, [
            ...
            },
            {
              ...
              value: function calcFindPhraseMatch(
                query,
                pageIndex,
                pageContent
              ) {
                ...
                var _loop = function _loop(i, ii) {
                  ...
                  promise = promise.then(function() {
                    return _this2.pdfViewer.getPageTextContent(i).then(
                      ...
                      function(reason) {
                        console.error(
                          'Unable to get page ' + (i + 1) + ' text content',
                          reason
                        )
            ...
            },
            {
              ...
              value: function executeCommand(cmd, state) {
                ...
                this._firstPagePromise.then(function() {
                  ...
                  if (cmd === 'find') {
                    _this3.findTimeout = setTimeout(
                      _this3.nextMatch.bind(_this3),
                      FIND_TIMEOUT
                    )
                  } else {
                    _this3.nextMatch()
            ...
            },
            {
              ...
              value: function updateMatchPosition(
                pageIndex,
                matchIndex,
                elements,
                beginIdx
                ...
                if (
                  this.selected.matchIdx === matchIndex &&
